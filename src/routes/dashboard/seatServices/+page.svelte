					...
					>
						{#each items as item, index (item.id)}
							<tr animate:flip={{ duration: flipDurationMs }}>
								<td class="p-3 border border-gray-600 bg-[#1f2937]">
								...
								{#if item.seat_services_languages}
									<td class="p-3 border border-gray-600 bg-[#1f2937] text-gray-300">
								...
								{/if}
								<td class="p-3 border border-gray-600 bg-[#1f2937] text-gray-300 w-32">
									<div class="flex justify-center items-center gap-2">
										<button
											on:click={() => {
