<script>
	...
	// console.log('vedioStore//', vedioStore);
	...
	async function fetchData() {
		...
		console.log('mediaVideo data///////', mediaVideoData);
...
<div class="max-w-screen-2xl mx-auto py-10">
	<div class="py-5 flex justify-end">
		<Button on:click={createMediaVideo} class="bg-primary-dark hover:bg-primary-50 flex gap-2">
			<svg
				width="20px"
				height="20px"
				viewBox="0 0 24 24"
	...
	<div class="overflow-x-auto">
		<table class="border-collapse w-full">
			...
			<tbody>
				{#each $vedioStore as item, index (item.id)}
					<tr>
						...
						<td class="p-3 font- bg-gray-10 text-gray-600 border border-gray-200 table-cell">
							<div class="flex items-center">
								<button
									on:click={() => {
										goto(`/dashboard/mediaVideo/${item.id}`);
									}}
