...
<div class="max-w-screen-2xl mx-auto py-10">
	...
	<div>
		<div class="py-5 flex justify-end">
			<Button on:click={createAbout} class="bg-primary-dark hover:bg-primary-50 flex gap-2">
				<svg
					width="20px"
					height="20px"
					viewBox="0 0 24 24"
							...
							<td class="p-3 bg-gray-10 border border-gray-200 table-cell">
								<div class="flex justify-center">
									<img
										...
										src={item.image
											? `${import.meta.env.VITE_PUBLIC_SUPABASE_STORAGE_URL}/${item.image}`
	...
	<div class="py-10">
		<div class="py-5 flex justify-end">
			<Button on:click={createStaff} class="bg-primary-dark hover:bg-primary-50 flex gap-2">
				<svg
					width="20px"
					height="20px"
					viewBox="0 0 24 24"
